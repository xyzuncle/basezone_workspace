package com.kq.perimission.gen;
...
import com.kq.perimission.PerimissionApplication;
...
public class MpGenerator {
    ...
    private static String URL="jdbc:mysql://192.168.101.98:3306/ZYWX?characterEncoding=utf8&useSSL=true";
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\workspace\\idea_workspace\\basezone_workspace\\perimission\\src\\main\\java");
        ...
        strategy.setInclude(new String[] {"base_online_user"}); // 需要生成的表
        ...
        // 自定义 controller 父类
           strategy.setSuperControllerClass("com.kq.perimission.controller.BaseController");
        ...
        pc.setParent("com.kq.perimission");
        //这里是包名后的名字，这里是为了做测试
